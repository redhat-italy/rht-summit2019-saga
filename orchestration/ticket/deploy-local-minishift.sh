...
oc new-app -e POSTGRESQL_USER=mauro -ePOSTGRESQL_PASSWORD=secret -ePOSTGRESQL_DATABASE=ticket openshift/postgresql-92-centos7 --name=ticket-database

# Wait for `ticket-database` application to be running.
