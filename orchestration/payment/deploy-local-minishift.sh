...
oc new-app -e POSTGRESQL_USER=mauro -ePOSTGRESQL_PASSWORD=secret -ePOSTGRESQL_DATABASE=payment openshift/postgresql-92-centos7 --name=payment-database

# Wait for `payment-database` application to be running.
